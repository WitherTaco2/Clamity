...
namespace Clamity.Content.Rarities
{
    public class EvercoldCyan : ModRarity
    {
        public override Color RarityColor => TextClr * 2f;

        public static float MaxY = 4f;
        public static float MaxX = 2f;
        public static Color BloomClr = new Color(38, 67, 95, 0); //yeee six-seven. Kill me!
        public static Color TextClr = new Color(68, 103, 139, 255);
            ...
            Vector2 origin, Vector2 baseScale, float time, bool renderTextSparkles, DynamicSpriteFont font)
        {
            ...
            for (int i = 0; i < sparkleCount; i++)
            {
                ...
                spriteBatch.Draw(sparkle, new Vector2(X + lifeTime * MaxX, Y + lifeTime * MaxY + 3f) + v, null, white, sparkleRotation, sparkleOrigin,
                    lifeTime / MathHelper.TwoPi * 0.3f, SpriteEffects.None, 0f);
                spriteBatch.Draw(sparkle, new Vector2(X + lifeTime * MaxX, Y + lifeTime * MaxY + 2f) + v, null, white * 0.5f, sparkleRotation, sparkleOrigin,
                ...
                spriteBatch.Draw(sparkle, new Vector2(X + lifeTime * MaxX, Y + lifeTime * MaxY + 2f) + v, null, color2 * sinValue, sparkleRotation, sparkleOrigin,
        ...
        // CAL's TODO: Add a cooler alternative for reforge rarities
