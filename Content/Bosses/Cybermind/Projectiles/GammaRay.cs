using Clamity.Assets;
using Clamity.Commons.Something;
...
{
    internal class GammaRay : ModProjectile, IProjOwnedByBoss<Cyberhive>, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            // Stick above Noxus.
            Projectile.Center = Cyberhive.Myself.Center - Vector2.UnitY.RotatedBy(Cyberhive.Myself.rotation) * Cyberhive.Myself.scale * 200f;
        ...
        {
            Projectile.scale = Utilities.Convert01To010(Time / Lifetime) * 1.45f;
        ...
        {
            //target.AddBuff(ModContent.BuffType<NoxusFumes>(), Cyberhive.DebuffDuration_PowerfulAttack);
        }
        ...
        public Color ColorFunction(float completionRatio)
        {
            ...
            float opacity = Projectile.Opacity * Utilities.InverseLerp(1f, 0.91f, completionRatio) * Projectile.scale * 1.15f;
        ...
        public void DrawFrontGlow()
        {
            ...
            Vector2 origin = ClamityAssets.BloomCircle.Size() * 0.5f;
            ...
            Main.spriteBatch.Draw(ClamityAssets.BloomCircle, drawPosition, null, Color.White, 0f, origin, baseScale * 0.7f, 0, 0f);
            Main.spriteBatch.Draw(ClamityAssets.BloomCircle, drawPosition, null, Color.Violet * 0.4f, 0f, origin, baseScale * 1.2f, 0, 0f);
            Main.spriteBatch.Draw(ClamityAssets.BloomCircle, drawPosition, null, Color.Blue * 0.3f, 0f, origin, baseScale * 1.7f, 0, 0f);
        }
