...
namespace Clamity.Content.Bosses.Clamitas.Projectiles
{
    public abstract class RancorLaserbeamHostile : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (MainClamitas is null || !MainClamitas.active)
            {
                Projectile.Kill();
                return;
            }
            ...
            Vector2 circlePointDirection = Projectile.velocity.SafeNormalize(Vector2.UnitX);
            Projectile.Center = MainClamitas.Center;
            ...
            // Update aim.
            UpdateRotation(ref Projectile.rotation);
            UpdateAim();
        ...
        public virtual void UpdateRotation(ref float rotation)
        {
