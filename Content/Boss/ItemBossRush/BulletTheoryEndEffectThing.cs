...
{
    public class BulletTheoryEndEffectThing : ModProjectile, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = TwentyTwoBulletTheory.EndVisualEffectTime;
        ...
        {
            if (Time == 25f)
                SoundEngine.PlaySound(TwentyTwoBulletTheory.VictorySound, Main.LocalPlayer.Center);

            Projectile.Center = Owner.Center;
            TwentyTwoBulletTheory.SyncEndTimer((int)Time);
