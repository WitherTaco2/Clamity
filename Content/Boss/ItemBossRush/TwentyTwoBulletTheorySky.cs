...
{
    public class TwentyTwoBulletTheorySky : CustomSky
    {
        ...
        public static Color GeneralColor => Color.Lerp(Color.LightGray, Color.Black, TwentyTwoBulletTheory.WhiteDimness) * 0.2f;
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (maxDepth >= float.MaxValue && minDepth < float.MaxValue && (BossRushEvent.EndTimer < BossRushEvent.EndVisualEffectTime - 40f || ShouldDrawRegularly))
            {
                ...
                Color baseColorDraw = Color.Lerp(Color.White, Color.OrangeRed, IncrementalInterest);
                if (Main.getGoodWorld)
                    baseColorDraw = Main.DiscoColor;
